...
export default function Introduction() {
  return (
    ...
    >
      ...
      <motion.h2
        className="mt-2 text-2xl text-soft-blue text-center p-4 mb-5"
        initial="hidden"
        animate="visible"
      ...
      <div className="flex justify-center items-center gap-2">
        <motion.div
          initial="hidden"
          animate="visible"
          variants={upPositionVariants({ delay: 1 })}
        >
          <Link
            href="https://www.linkedin.com/in/vinicius-takedi/"
            target="_blank"
            className="flex justify-center p-2 w-28 rounded-lg gap-1 text-soft-blue font-bold hover:text-blue transition-all bg-white"
          >
        ...
        <motion.div
          initial="hidden"
          animate="visible"
          variants={upPositionVariants({ delay: 1.2 })}
        >
          <Link
