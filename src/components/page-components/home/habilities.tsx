...
export default function Habilities() {
  return (
    <div className="flex flex-col justify-center items-center lg:px-24 md:px-10 px-5 py-8">
      <div className="flex gap-5 lg:flex-row flex-col">
        <div className="lg:w-2/4 lg:mb-0 md:mb-10 mb-6">
          ...
          <p className="text-lg text-white leading-6 mb-2">
        ...
        <div className="lg:w-2/4">
          ...
          <p className="text-lg text-white leading-6 mb-2">
            ...
            para mais informações, entre em contato comigo, vamos conversar e trocar pensamentos, 
